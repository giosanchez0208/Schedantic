...
DAY_CODES: dict[str, list[tuple[str, float]]] = {
    ...
    "MO": [('Mondays', 2.0), ('mondays', 1.5), ('Mons', 0.4), ("M", 3.0), ("Mon", 3.0), ("Monday", 3.0), ("mon", 2.0), ("monday", 2.0)],
    "TU": [('Tuesdays', 2.0), ('tuesdays', 1.5), ('Tues days', 0.1), ("T", 2.0), ("Tue", 2.5), ("Tues", 2.0), ("Tuesday", 3.0), ("tues", 1.5)],
    "WE": [('Wednesdays', 2.0), ('wednesdays', 1.5), ('Weds', 0.8), ("W", 3.0), ("Wed", 3.0), ("Wednesday", 3.0), ("wed", 2.0)],
    "TH": [('Thursdays', 2.0), ('thursdays', 1.5), ("Th", 2.5), ("Thu", 2.0), ("Thurs", 2.0), ("Thursday", 3.0), ("R", 1.5)],
    "FR": [('Fridays', 2.0), ('fridays', 1.5), ("F", 3.0), ("Fri", 3.0), ("Friday", 3.0), ("fri", 2.0)],
    "SA": [('Saturdays', 2.0), ('saturdays', 1.5), ("S", 1.0), ("Sat", 3.0), ("Saturday", 2.5), ("sat", 2.0)],
    "SU": [('Sundays', 2.0), ('sundays', 1.5), ("Su", 1.5), ("Sun", 2.5), ("Sunday", 2.5), ("U", 0.5)],
